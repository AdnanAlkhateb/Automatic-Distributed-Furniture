...
namespace Assets.Genetic_Algorithm.Scripts
{
    class RoomController : MonoBehaviour
    {
        ...
        {
            GA.NewGeneration();
            Debug.Log(_validFurnitureObjectList[0].transform.position);
             if (Physics.Linecast (_validFurnitureObjectList[0].transform.position, _validFurnitureObjectList[1].transform.position)) {
